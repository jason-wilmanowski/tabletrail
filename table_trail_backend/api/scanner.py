...
from table_trail_backend.schemas.database_schema import DatabaseResponse, CreateDatabase
...
from table_trail_backend.core.exceptions import ScanningSystemError, DatabaseSystemError

router = APIRouter(prefix="/scanner", tags=["scanner"])


@router.post("", response_model=DatabaseResponse)
async def create_database(database_details: CreateDatabase, db: AsyncSession = Depends(get_db)) -> DatabaseResponse:
